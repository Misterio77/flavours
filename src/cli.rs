        ...
        .subcommand(
            App::new("generate")
                ...
                .arg(
                    ...
                    .long("slug")
                    .short('s')
                    .about("Scheme slug (lowercase with hyphens) to output to. If ommited, defaults to 'generated'")
                    .value_name("name")
                    .takes_value(true)
                    .value_hint(ValueHint::Other)
                )
                ...
                .arg(
                    ...
                    .long("mode")
                    .short('m')
                    .about("Whether to generate a dark scheme, light scheme, or based on the image (default if ommited)")
                    .possible_values(&["auto", "dark", "light"])
                    .value_name("name")
                    .takes_value(true)
                    .value_hint(ValueHint::Other)
                )
